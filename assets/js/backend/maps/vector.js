...
(function(factory) {
  ...
  $(function() {
     ...
     */
    $.when(
      $.getScript($('body').data('baseurl') + 'plugins/jqvmap/js/maps/continents/jquery.vmap.asia.js'),
      $.Deferred(function(deferred) {
        $(deferred.resolve);
      })
    ).done(function() {
     ...
     */
    $.when(
      $.getScript($('body').data('baseurl') + 'plugins/jqvmap/js/maps/continents/jquery.vmap.europe.js'),
      $.Deferred(function(deferred) {
        $(deferred.resolve);
      })
    ).done(function() {
     ...
     */
    $.when(
      $.getScript($('body').data('baseurl') + 'plugins/jqvmap/js/maps/continents/jquery.vmap.australia.js'),
      $.Deferred(function(deferred) {
        $(deferred.resolve);
      })
    ).done(function() {
     ...
     */
    $.when(
      $.getScript($('body').data('baseurl') + 'plugins/jqvmap/js/maps/continents/jquery.vmap.africa.js'),
      $.Deferred(function(deferred) {
        $(deferred.resolve);
      })
    ).done(function() {
     ...
     */
    $.when(
      $.getScript($('body').data('baseurl') + 'plugins/jqvmap/js/maps/continents/jquery.vmap.north-america.js'),
      $.Deferred(function(deferred) {
        $(deferred.resolve);
      })
    ).done(function() {
     ...
     */
    $.when(
      $.getScript($('body').data('baseurl') + 'plugins/jqvmap/js/maps/continents/jquery.vmap.south-america.js'),
      $.Deferred(function(deferred) {
        $(deferred.resolve);
      })
    ).done(function() {
