    ...
    PLUGINS: function() {
      ...
      (function() {
        ...
        $(element).on('click', handler, function(e) {
          ...
          panel.transition({
            ...
            // publish event
            $(element).trigger(settings.eventPrefix + '.panelcollapse.remove', {
              'element': $(panel)
            });
          });
      ...
      (function() {
        ...
        var open = function() {
          ...
          $(element).trigger(settings.eventPrefix + '.sidebar.open', {
            'element': $(sidebar)
          });
        };
        ...
        var close = function() {
          if ($(element).hasClass(openClass + '-' + direction)) {
            ...
            $(element).trigger(settings.eventPrefix + '.sidebar.close', {
              'element': $(sidebar)
            });
          }
        };
